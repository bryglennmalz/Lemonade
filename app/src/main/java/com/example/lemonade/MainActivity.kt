...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val imgLemonState: ImageView = findViewById(R.id.image_lemon_state)
        // TODO: set up a conditional that tracks the lemonadeState
        when(lemonadeState){
            SELECT -> {
                textAction.text = "Click to select a lemon!"
                imgLemonState.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE ->{
                textAction.text = "Click to juice the lemon!"
                imgLemonState.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK ->{
                textAction.text ="Click to drink your lemonade!"
                imgLemonState.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.text ="Click to start again!"
                imgLemonState.setImageResource(R.drawable.lemon_restart)
            }
        }
